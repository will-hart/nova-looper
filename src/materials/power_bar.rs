use bevy::{
    color::palettes::tailwind::EMERALD_400, prelude::*, render::render_resource::AsBindGroup,
};

use crate::{Pause, player::PlayerPower, screens::Screen};
...
pub(super) fn plugin(app: &mut App) {
    ...
    app.add_systems(OnEnter(Screen::Gameplay), spawn_power_bar);
